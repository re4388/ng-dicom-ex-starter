...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["cornerstoneWADOImageLoaderWebWorker"] = factory();
})(this, function () {
  return /******/ (function (modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./webWorker/index.js")
    );
    /******/
  })(
    /************************************************************************/
  ...
  \***********************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _getMinMax = __webpack_require__(
            /*! ./getMinMax.js */ "./shared/getMinMax.js"
          );
  ...
  \************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _decodeLittleEndian = __webpack_require__(
            /*! ./decoders/decodeLittleEndian.js */ "./shared/decoders/decodeLittleEndian.js"
          );

          var _decodeLittleEndian2 = _interopRequireDefault(
            _decodeLittleEndian
          );

          var _decodeBigEndian = __webpack_require__(
            /*! ./decoders/decodeBigEndian.js */ "./shared/decoders/decodeBigEndian.js"
          );

          var _decodeBigEndian2 = _interopRequireDefault(_decodeBigEndian);

          var _decodeRLE = __webpack_require__(
            /*! ./decoders/decodeRLE.js */ "./shared/decoders/decodeRLE.js"
          );

          var _decodeRLE2 = _interopRequireDefault(_decodeRLE);

          var _decodeJPEGBaseline = __webpack_require__(
            /*! ./decoders/decodeJPEGBaseline.js */ "./shared/decoders/decodeJPEGBaseline.js"
          );

          var _decodeJPEGBaseline2 = _interopRequireDefault(
            _decodeJPEGBaseline
          );

          var _decodeJPEGLossless = __webpack_require__(
            /*! ./decoders/decodeJPEGLossless.js */ "./shared/decoders/decodeJPEGLossless.js"
          );

          var _decodeJPEGLossless2 = _interopRequireDefault(
            _decodeJPEGLossless
          );

          var _decodeJPEGLS = __webpack_require__(
            /*! ./decoders/decodeJPEGLS.js */ "./shared/decoders/decodeJPEGLS.js"
          );

          var _decodeJPEGLS2 = _interopRequireDefault(_decodeJPEGLS);

          var _decodeJPEG = __webpack_require__(
            /*! ./decoders/decodeJPEG2000.js */ "./shared/decoders/decodeJPEG2000.js"
          );
          ...
          function decodeImageFrame(
            ...
            if (transferSyntax === "1.2.840.10008.1.2") {
              ...
              imageFrame = (0, _decodeLittleEndian2.default)(
                imageFrame,
                pixelData
              );
              ...
              imageFrame = (0, _decodeBigEndian2.default)(
                imageFrame,
                pixelData
              );
              ...
              imageFrame = (0, _decodeJPEGBaseline2.default)(
                imageFrame,
                pixelData
              );
              ...
              imageFrame = (0, _decodeJPEGLossless2.default)(
                imageFrame,
                pixelData
              );
              ...
              // JPEG 2000 Lossless
              imageFrame = (0, _decodeJPEG2.default)(
                imageFrame,
                pixelData,
                decodeConfig,
                options
              ...
              throw new Error(
                "no decoder for transfer syntax " + transferSyntax
              );
            }
            ...
            if (shouldShift && shift !== undefined) {
              for (var i = 0; i < imageFrame.pixelData.length; i++) {
                ...
                imageFrame.pixelData[i] =
                  (imageFrame.pixelData[i] << shift) >> shift;
              }
            }
          ...
          function decodeBigEndian(imageFrame, pixelData) {
            if (imageFrame.bitsAllocated === 16) {
              ...
              if (imageFrame.pixelRepresentation === 0) {
                ...
                imageFrame.pixelData = new Int16Array(
                  arrayBuffer,
                  offset,
                  length / 2
                );
  ...
  \*******************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function decodeJpx(imageFrame, pixelData) {
            ...
            if (tileCount !== 1) {
              throw new Error(
                "JPEG2000 decoder returned a tileCount of " +
                  tileCount +
                  ", when 1 is expected"
              );
            }
          ...
          function decodeOpenJPEG(data, bytesPerPixel, signed) {
            ...
            var src32 = new Int32Array(
              openJPEG.HEAP32.buffer,
              imagePtr,
              length
            );
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function decodeJPEGBaseline(imageFrame, pixelData) {
            ...
            if (imageFrame.bitsAllocated === 8) {
              imageFrame.pixelData = jpeg.getData(
                imageFrame.columns,
                imageFrame.rows
              );
              ...
              imageFrame.pixelData = jpeg.getData16(
                imageFrame.columns,
                imageFrame.rows
              );
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function decodeJPEGLS(imageFrame, pixelData) {
            ...
            if (image.result !== 0 && image.result !== 6) {
              throw new Error(
                "JPEG-LS decoder failed to decode frame (error code " +
                  image.result +
                  ")"
              );
            }
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function decodeLittleEndian(imageFrame, pixelData) {
            ...
            if (imageFrame.bitsAllocated === 16) {
              ...
              imageFrame.pixelData = new Float32Array(
                arrayBuffer,
                offset,
                length / 4
              );
  ...
  \**************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function decode8(imageFrame, pixelData) {
            ...
            var outFrame = new ArrayBuffer(
              frameSize * imageFrame.samplesPerPixel
            );
          ...
          function decode16(imageFrame, pixelData) {
            ...
            var frameSize = imageFrame.rows * imageFrame.columns;
            var outFrame = new ArrayBuffer(
              frameSize * imageFrame.samplesPerPixel * 2
            );
  ...
  \********************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _decodeJPEG = __webpack_require__(
            /*! ../../shared/decoders/decodeJPEG2000.js */ "./shared/decoders/decodeJPEG2000.js"
          );

          var _decodeJPEGLS = __webpack_require__(
            /*! ../../shared/decoders/decodeJPEGLS.js */ "./shared/decoders/decodeJPEGLS.js"
          );

          var _calculateMinMax = __webpack_require__(
            /*! ../../shared/calculateMinMax.js */ "./shared/calculateMinMax.js"
          );

          var _calculateMinMax2 = _interopRequireDefault(_calculateMinMax);

          var _decodeImageFrame = __webpack_require__(
            /*! ../../shared/decodeImageFrame.js */ "./shared/decodeImageFrame.js"
          );
          ...
          function handler(data, doneCallback) {
            ...
            var strict =
              ...
              decodeConfig.decodeTask.strict;
  ...
  \****************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _version = __webpack_require__(
          ...
          var _webWorker = __webpack_require__(
            /*! ./webWorker.js */ "./webWorker/webWorker.js"
          );

          var _decodeTask = __webpack_require__(
            /*! ./decodeTask/decodeTask.js */ "./webWorker/decodeTask/decodeTask.js"
          );
